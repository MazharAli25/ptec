...
@section('main-content')
    ...
    <div class="flex-1 p-8 ml-[19vw]">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Add Grade</h1>
            <p class="text-gray-600 mt-2">Fill in the details to add grades</p>
        </div>


        <!-- Form Section -->
        <div class="bg-white rounded-lg form-shadow p-6 mb-8 flex justify-center">
            <form class="flex flex-col w-[70%]" method="POST" action="{{ route('grade.store') }}">
                @csrf
                <div class="space-y-4">
                    <h2 class="text-lg font-semibold text-gray-700 border-b pb-2">Grade Information</h2>
                    <div class="flex justify-center">
                        <div>
                            <label for="grade" class="block text-sm font-medium text-gray-700 mb-1 w-[400px]">
                                Add Grade
                            </label>
                            <input type="text" id="grade" name="grade" placeholder="Enter Grade Here"
        ...
        <div class="bg-white rounded-lg form-shadow p-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-800">Grades List</h2>
